...
module.exports = {
    name: "setmoneymax",
    aliases: ["setmmax"],
    description: "Setting maksimum uang yang bisa didapatkan lewat chat",
    usage: "<nominal>",
    category: "settings",
    /**
   * 
   ...
   */
    run: async(client, message, args) => {
        ...
        .setDescription(`Successfully set money income maximum to Rp. ${args[0]}`)
        .setTimestamp(new Date())
        .setColor(COLOR)
        modlog.send({embed: e});
        data.money.max = args[0]; data.save();
    },
};